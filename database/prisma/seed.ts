...
const protocolSeeds = [
  {
    ...
    content:
      "This is the phase-1 privacy policy placeholder for the AI Tarot MVP.",
  },
  {
    ...
    content:
      "This service provides reflective content only and does not replace professional advice.",
  },
  {
    ...
    content:
      "Interpretations are generated with AI assistance and require user judgment.",
  },
  {
    ...
    content:
      "Users should confirm they meet the minimum age requirement before continuing.",
  },
] as const;
...
const main = async () => {
  ...
  console.log(
    "Seeded admin account, protocol versions, product SKUs, prompt policy, and topic templates.",
  );
};
